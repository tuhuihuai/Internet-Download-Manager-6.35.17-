@ECHO OFF & CD /D %~DP0 & TITLE 卸载 www.Laomo.me 
...
If Exist "%Public%" Rundll32 setupapi.dll,InstallHinfSection DefaultUninstall 128 .\App\idmwfp.inf
If Not Exist "%Public%" Rundll32 setupapi.dll,InstallHinfSection DefaultUninstall 128 .\App\idmtdi.inf

If "%PROCESSOR_ARCHITECTURE%"=="AMD64" Regsvr32 /s /u App\IDMShellExt64.dll
...
regedit /e "设置备份.reg" HKEY_CURRENT_USER\Software\DownloadManager >NUL 2>NUL
